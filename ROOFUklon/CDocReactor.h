...
//-----------------------------------------------------------------------------
//----- CDocReactor.h : Declaration of the CDocReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ CDocReactor : public AcApDocManagerReactor {

public:
	ACRX_DECLARE_MEMBERS(CDocReactor) ;
...
public:
	CDocReactor (const bool autoInitAndRelease =true) ;
	virtual ~CDocReactor () ;
...
#ifdef ROOFUKLON_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CDocReactor)
#endif
