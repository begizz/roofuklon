...
//-----------------------------------------------------------------------------
//----- CDBReactor.h : Declaration of the CDBReactor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ CDBReactor : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(CDBReactor) ;
...
public:
	CDBReactor (AcDbDatabase *pDb =NULL) ;
	virtual ~CDBReactor () ;
...
#ifdef ROOFUKLON_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CDBReactor)
#endif
